...
export type ImageMutationsResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["ImageMutations"],
> = {
    purchaseImage?: Resolver<
        ResolversTypes["Image"],
        ParentType,
        ContextType,
        RequireFields<ImageMutationsPurchaseImageArgs, "input">
    >;
    updateImage?: Resolver<
        ResolversTypes["Image"],
        ParentType,
        ContextType,
        RequireFields<ImageMutationsUpdateImageArgs, "input">
    >;
    uploadImage?: Resolver<
        ResolversTypes["Image"],
        ParentType,
        ContextType,
        RequireFields<ImageMutationsUploadImageArgs, "input">
    >;
    uploadImages?: Resolver<
        Array<ResolversTypes["Image"]>,
        ParentType,
        ContextType,
        RequireFields<ImageMutationsUploadImagesArgs, "input">
    >;
    uploadImagesFromFile?: Resolver<
        ResolversTypes["ID"],
        ParentType,
        ContextType,
        RequireFields<ImageMutationsUploadImagesFromFileArgs, "url">
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ImageOwnershipResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["ImageOwnership"],
> = {
...
export type ObjectResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["Object"],
> = {
...
export type PriceResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["Price"],
> = {
...
> = {
    get?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<QueryGetArgs, "id">
    >;
    imageUploadUrls?: Resolver<
        Array<ResolversTypes["UploadUrl"]>,
        ParentType,
        ContextType,
        RequireFields<QueryImageUploadUrlsArgs, "fileExtensions">
    >;
...
export type UploadUrlResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["UploadUrl"],
> = {
...
export type UserMutationsResolvers<
    ContextType = CustomContextType,
    ParentType = ResolversParentTypes["UserMutations"],
> = {
    login?: Resolver<
        ResolversTypes["User"],
        ParentType,
        ContextType,
        RequireFields<UserMutationsLoginArgs, "input">
    >;
    register?: Resolver<
        ResolversTypes["User"],
        ParentType,
        ContextType,
        RequireFields<UserMutationsRegisterArgs, "input">
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
